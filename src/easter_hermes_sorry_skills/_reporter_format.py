...
TDD tests reference ``easter_hermes_sorry_skills._reporter.format_text`` /
...
from easter_hermes_sorry_skills import _reporter_format_consts as _consts
from easter_hermes_sorry_skills import _reporter_format_json as _json
from easter_hermes_sorry_skills import _reporter_format_text_value as _text
