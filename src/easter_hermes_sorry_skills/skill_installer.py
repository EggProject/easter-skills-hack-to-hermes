"""easter_hermes_sorry_skills.skill_installer — installs the migrated skill-creator.
...
from easter_hermes_sorry_skills import _skill_installer_io as _io_mod
from easter_hermes_sorry_skills._skill_installer_cap import detect_active_cap
from easter_hermes_sorry_skills._skill_installer_consts import (
    FULL_DESC_CAP,
    LIVE_HERMES_AGENT,
    PINNED_UPSTREAM_COMMIT,
    SHORT_DESC_CAP,
)
from easter_hermes_sorry_skills._skill_installer_t3 import T3_INVENTORY
...
def install(
    *,
    ...
    return _build_install_result(target_dir, target_md)
