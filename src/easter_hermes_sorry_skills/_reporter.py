"""src/easter_hermes_sorry_skills/_reporter.py

Format text/JSON output and sort rows for the reporter. Owns: easter_hermes_sorry_skills.
...
from easter_hermes_sorry_skills import _reporter_format_json as _json_mod
from easter_hermes_sorry_skills import _reporter_format_text_value as _text_mod
