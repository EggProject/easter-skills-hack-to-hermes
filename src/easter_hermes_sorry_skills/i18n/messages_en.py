...
OK_WOULD_PATCH = "✓ site {site_id} validated; patch would be applied"
PERMISSION_DENIED = "✗ permission denied writing {path}"
IO_ERROR = "✗ I/O error writing {path}: {error}"
SNAPSHOT_PURGED = "✓ skills prompt snapshot purged: {path}"
SNAPSHOT_PURGE_FAILED = "⚠ could not purge skills prompt snapshot {path}: {error}"
