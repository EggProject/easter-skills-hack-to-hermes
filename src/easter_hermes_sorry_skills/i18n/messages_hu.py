...
OK_WOULD_PATCH = "✓ a {site_id} hely érvényes; a patch alkalmazható"
PERMISSION_DENIED = "✗ írási engedély megtagadva: {path}"
IO_ERROR = "✗ I/O hiba a {path} írásakor: {error}"
SNAPSHOT_PURGED = "✓ skills prompt snapshot törölve: {path}"
SNAPSHOT_PURGE_FAILED = "⚠ a skills prompt snapshot nem törölhető ({path}): {error}"
