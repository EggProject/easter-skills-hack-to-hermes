...
from hermes_skill_creator_plugin._patcher_consts import EXIT_USER_ABORT
from hermes_skill_creator_plugin._patcher_force_confirm_diff import build_diff_text
