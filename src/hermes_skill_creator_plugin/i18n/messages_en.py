...
REPORT_USAGE_HEADER = (
    "[en] Usage: hermes-skill-creator-report [OPTIONS] / " "[hu] Használat: hermes-skill-creator-report [OPTIONS]"
)
...
MIGRATION_REGENERATED = (
    "[en] migration note regenerated at {path} / " "[hu] migrációs jegyzet újragenerálva itt: {path}"
)
