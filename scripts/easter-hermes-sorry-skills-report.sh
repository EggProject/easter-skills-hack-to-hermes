...
exec "${PYZ_PATH}" -c "import sys; sys.argv[0] = 'easter-hermes-sorry-skills-report'; from easter_hermes_sorry_skills.cli_report import main; main(standalone_mode=True)" "$@"
