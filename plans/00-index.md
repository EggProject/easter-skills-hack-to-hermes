...
- **Evidence**: V1 finding (this round) + V6 RR2 / V4 RR2. Confidence: inferred (process rule); verified-from-source (live `wc -l` for all 14 files post-fix: 111,142,242,253,249,183,283,263,213,392,333,157,204,304 = 3329; Total cell = 3329; per-file Budget cells unchanged from V7).
