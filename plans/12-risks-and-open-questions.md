...
| E6 | 2026-06-17 | (Q6) line budget | 3960 sum (see 00-index for per-file table) | default accepted | pre-commit hook `tools/check_line_count.py` enforces per-file budget; sum < 4500; 00-index is single source of truth. |
